...
@implementation SBTAnimationWaiting


+ (UIImageView *)animationOnView:(UIView *)superview
{
    ...
    [SBTAnimationWaiting animation:view matrixTransformArray:matrixsTransform nameArray:names
        positionWithScaleArray:positionWithScale];
    return view;
}

+ (void)animation:(UIImageView *)view matrixTransformArray:(NSArray *)matrixTransformArray nameArray:(NSArray *)nameArray
